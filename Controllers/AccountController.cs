...
using Undisclosed_Shop.Controllers;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                PdfTextElement element = new PdfTextElement("Invoice " + model.Name.ToString() + " for" + " " + model.Email, subHeadingFont);
                element.Brush = PdfBrushes.White;

                //Draws the heading on the page
                PdfLayoutResult res = element.Draw(page, new PointF(10, bounds.Top + 8));
                string currentDate = "Date Purchased " + DateTime.Now;
             ...
             //   invoiceDetails.Columns.Add("Quantity");
              ...
              //  foreach (var item in sale.SaleDetails.Where(m => m.SaleId == sale.SaleId))
               ...
               // }
                ...
                mail.From = from;
                mail.Subject = "Your invoice for order number #" + model.Email;
                mail.Body = "Dear Customer" + model.Name + " find your invoice in the attached PDF document.";
                mail.To.Add(emailTo);
